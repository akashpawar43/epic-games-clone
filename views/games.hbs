...
<head>
    ...
    <link rel="stylesheet" href="/css/2_nav2.css">
    <link rel="stylesheet" href="/css/3_carousel.css">
    <link rel="stylesheet" href="/css/6_games_pg.css">
    <link rel="stylesheet" href="/css/10_media_games.css">
    <style>
        html {
            font-size: 62.5%;
            overflow-x: hidden;
